...
Malaga, Spain (Spanish resident, UK passport; remote-ready)
...
AI-assisted development, agentic workflows, rapid prototyping, full-stack product engineering, JavaScript/TypeScript, Node.js and Next.js product engineering, Elixir and Phoenix, iOS app development, systems thinking, product strategy, technical design, customer discovery, founder-led delivery, video and audio product workflows.

## EXPERIENCE

### Func Main, Founder, Tech & Product - June 2016 - Present
...
- [BlaBlaAHA!](https://apps.apple.com/gb/app/blablaaha-learn-spanish/id6755297500), an AI-native, audio-first language app built around short listening sessions, conversational confidence, and fast content iteration.
- [Bend.com](https://www.bend.com), AI, social, and backend feature work for one of the world's most popular stretching apps.
- [ElevenLabs Hacks](https://www.instagram.com/reel/DYBAKTMIMBD/?igsh=MWozM3o3bXY0NGtmeg==), competed in 3 ElevenLabs Hacks, building rapid voice and agentic media prototypes, and won Gold in the Vercel challenge.
- Remotion Video Creator, a Next.js and Remotion video editor for prompting, composing, and rendering videos directly from code.
- Photo to Playlist, an agent workflow that reads a flyer or festival poster from a photo and turns it into a playlist.
...
### Pulse Films, Video Director - 2006 - 2012
...
### Bournemouth University - Bachelor's Degree, TV Production, 2003 - 2006
